...
Doctrine_Manager::getInstance()->bindComponent('DirectoryIn_Model_Listing', 'doctrine');

/**
 * DirectoryIn_Model_BaseListing
 * 
 ...
 */
abstract class DirectoryIn_Model_BaseListing extends Doctrine_Record
{
