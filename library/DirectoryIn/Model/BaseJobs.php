...
Doctrine_Manager::getInstance()->bindComponent('DirectoryIn_Model_Jobs', 'doctrine');

/**
 * DirectoryIn_Model_BaseJobs
 * 
 ...
 */
abstract class DirectoryIn_Model_BaseJobs extends Doctrine_Record
{
