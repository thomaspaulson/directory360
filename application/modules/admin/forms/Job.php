...
class Admin_Form_Job extends Zend_Form
{
	public function init()
	{
		...
		$skill->setLabel('Skills:')
		->setOptions(array('size' => '35'));
		$title->setRequired(true);
		
		

		$shortDescription = new Zend_Form_Element_Text('ShortDesc');
		...
		$displayUntil->setLabel('Displat until:')
		->setOptions(array('size' => '35'));		
		...
		array('ID', 'Title', 'URL', 'Content', 'Skill','ShortDesc','Address','City','District','Phone','Email','WebsiteURL','DisplayUntil','Status')
		, 'PageContent'	);
